...
const paths = {
  ...
  branch: '<circle cx="6" cy="5" r="2"/><circle cx="6" cy="19" r="2"/><circle cx="18" cy="9" r="2"/><path d="M6 7v10"/><path d="M18 11c0 3-3 4-6 4s-6 1-6 2"/>',
  chart: '<path d="M4 19h16"/><path d="M7 16V9"/><path d="M12 16V5"/><path d="M17 16v-6"/>',
  chat: '<path d="M5 6.5A2.5 2.5 0 0 1 7.5 4h9A2.5 2.5 0 0 1 19 6.5v7a2.5 2.5 0 0 1-2.5 2.5H10l-4.5 3.5V16A2.5 2.5 0 0 1 5 13.5z"/>',
  send: '<path d="m4 12 16-8-5 16-3-6z"/><path d="M12 14l8-10"/>',
  ...
  lang: '<path d="M4 5h9"/><path d="M8.5 3v2"/><path d="M6 8c1.3 3.2 3.2 5.3 5.5 6.5"/><path d="M11 8c-1 3.5-3.5 6.4-6.5 8"/><path d="m13 20 3.5-8 3.5 8"/><path d="M14.3 17h4.4"/>',
  ...
  key: '<circle cx="8" cy="15" r="4"/><path d="m11 12 9-9"/><path d="m17 6 2 2"/><path d="m14 9 2 2"/>',
